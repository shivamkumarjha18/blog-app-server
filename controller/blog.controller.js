...
export const deleteBlog = async (req, res) => {
    try {
        ...
        console.log("User (Author) ID:", authorId);

        const blog = await Blog.findById(blogId);
        console.log("Fetched Blog:", blog); // 🔍 check if it's null or missing fields
        ...
        console.error("Delete Blog Error:", error); // 🌟 very important
